...
\end{itemize}
All new changes are stored in a new file called {\it qet\_friends.py}\cite{friendlist}. The following is the output after running the Python program:
\vspace{2mm}
\begin{figure}[h!]
\centering
\fbox{\includegraphics[scale=0.65]{q4/fig3.png}}
...
\begin{figure}[h!]
\centering
\fbox{\includegraphics[scale=0.75]{q4/friend_plot.pdf}}
