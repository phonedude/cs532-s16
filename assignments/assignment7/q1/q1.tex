...
\lstinputlisting[language=Python, caption={tabulate function}, label=listing:tab, linerange={286-300}, firstnumber={286}]{recommendations.py}

\lstinputlisting[language=Python, caption={Question 1 code}, label=listing:q1, linerange={382-404}, firstnumber={382}]{recommendations.py}

\lstinputlisting[language=Python, caption={get\_top functions}, label=listing:avgtop, linerange={262-271}, firstnumber={262}]{recommendations.py}

\lstinputlisting[language=Python, caption={flatten function}, label=listing:flatten, linerange={377-378}, firstnumber={377}]{recommendations.py}
